...
Usage:
  python python/experiments/analyze_spp_error.py --traj 1.1
  python python/experiments/analyze_spp_error.py --all --output-dir experiments/output/spp_error
"""
...
DATA_BASE = PROJECT_ROOT / "data/real_vehicle"
