...
Usage:
  python3 python/experiments/exp3_deep_dive.py
"""
...
INPUT_CSV = BASE / 'data/real_vehicle/cmm_input_points.csv'
THRESHOLD_M = 5.0
...
phmi_data = load_output(BASE / 'data/real_vehicle/mr/multiplier_sweep/cmm_mult05.csv')
print("Loading baseline (no PHMI) data...")
base_data = load_output(BASE / 'data/real_vehicle/mr/multitraj_sweep/cmm_all_lag000.csv')
