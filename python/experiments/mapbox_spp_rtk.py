...
Usage:
  python python/experiments/mapbox_spp_rtk.py --traj 11
  python python/experiments/mapbox_spp_rtk.py --traj 11 --max-epochs 500 --output experiments/output/spp_error/mapbox_traj11.html
"""
