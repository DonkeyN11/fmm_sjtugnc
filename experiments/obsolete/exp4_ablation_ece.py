...
Usage:
  python3 python/experiments/exp4_ablation_ece.py
"""
...
# ── Existing data paths ──
SYNTH_DIR = BASE / 'data/real_vehicle/mr/synthetic'
REAL_DIR = BASE / 'data/real_vehicle/mr/multitraj_sweep'
PHMI_DIR = BASE / 'data/real_vehicle/mr/multiplier_sweep'
...
def run_cmm_config(name, out_file, **params):
    ...
    if 'synthetic' in name:
        ...
        root.find('input').find('gps').find('file').text = str(BASE / 'data/real_vehicle/cmm_input_points.csv')
...
ablation_dir = BASE / 'data/real_vehicle/mr/ablation'
...
fmm_csv = BASE / 'data/real_vehicle/mr/fmm_traj11_0508.csv'
if fmm_csv.exists():
